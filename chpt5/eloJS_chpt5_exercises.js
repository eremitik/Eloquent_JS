...
console.log(arrays.reduce(myFunc))

//better version
console.log(arrays.reduce(function(acc,n){return acc.concat(n)}))

//even shorter version
console.log(arrays.reduce((acc,n)=>acc.concat(n)))
...
function average(arr){
  return arr.reduce(function(a,b){a+b}) / arr.length
}
